...
**TASK:** Patient Messaging UI Components

**REQUIREMENTS:**
## Objective

Create patient-facing messaging UI components in the patient app. The backend messaging infrastructure is complete, but patients currently have no UI to view/send messages.

## Reference Implementation

Pharmacist messaging UI exists at:
- web/src/apps/pharmacist/features/messaging/

Use this as a reference for patterns, components, and API integration.

## Required Components

1. **MessagingPage.tsx** - Main messaging view for patients
   - List of conversations with pharmacists
   - Conversation selection
   - Integration with messaging context/hooks

2. **ConversationList.tsx** - List component showing all conversations
   - Display pharmacist name, last message, timestamp
   - Unread message indicators
   - Sort by most recent

3. **MessageThread.tsx** - Individual conversation view
...
5. **Add route** - Add messaging route to patient app routes

## Location

Create at: web/src/apps/patient/features/messaging/

## Testing

Create unit tests for each component following existing patterns.

## Acceptance Criteria

- [ ] All 4 components created with TypeScript
- [ ] Route added to patient app
- [ ] Components use existing messaging hooks/context
- [ ] Unit tests pass
- [ ] Build succeeds
