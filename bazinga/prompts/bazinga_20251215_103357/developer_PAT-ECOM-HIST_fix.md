...
**TASK:** Fix: Patient E-Commerce Order History - Missing Test IDs

**REQUIREMENTS:**
QA FAILED: 52/122 tests passed. E2E failures due to missing data-testid attributes.
...
The functionality is correct - only UI test selectors are missing.

Files location: web/src/apps/patient/

After adding test IDs, run tests to verify all E2E tests pass.
...
E2E failures due to missing data-testid attributes in OrderList, OrderCard, OrderDetail, OrderFilters components
