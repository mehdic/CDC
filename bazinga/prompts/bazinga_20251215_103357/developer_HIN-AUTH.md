...
**TASK:** T8-035: HIN e-ID Authentication Integration

**REQUIREMENTS:**
Implement HIN e-ID Authentication Integration for healthcare professionals.

**Functional Requirements:**
- Implement HIN OAuth2 flow (authorization code flow)
- Verify healthcare professional credentials
- Extract GLN number from HIN profile
- Store verified credential in user profile with verification timestamp

**Implementation Details:**
- Create HINAuthService in backend/services/auth-service/src/services/hinAuthService.ts
- Configure HIN OAuth URL: https://apps.hin.ch/oauth2
- Implement initiateHINAuth and handleCallback methods
- Use scopes: openid profile gln
- Extract sub, gln, role, name from HIN profile
