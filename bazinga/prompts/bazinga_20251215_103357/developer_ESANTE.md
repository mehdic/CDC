...
**TASK:** T8-036: Swiss e-sante API Integration

**REQUIREMENTS:**
Implement Swiss e-sante API Integration for cantonal health record access.

**Functional Requirements:**
- Connect to cantonal health record systems
- Fetch patient consent status
- Read authorized health records (FHIR format)
- Write consultation summaries (with consent)

**Implementation Details:**
- Create e-sante service in backend/services/health-records-service/
- Implement consent verification (per-access check)
- Implement FHIR record fetching
- Implement consultation summary write
- Handle both sandbox and production environments

**Acceptance Criteria:**
- [ ] e-sante connection established (sandbox first, then production)
