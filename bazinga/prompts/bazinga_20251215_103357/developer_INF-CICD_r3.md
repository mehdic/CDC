...
**TASK:** T8-057: CI/CD Pipeline - Fix Remaining Issues

**REQUIREMENTS:**
Tech Lead found 2 HIGH priority issues still unresolved.

Fix required:
1. Pin trivy-action version in docker-build-push.yml
2. Add timeout-minutes to jobs in:
   - docker-build-push.yml
   - k8s-deploy.yml
   - rollback.yml

This is round 3 - be thorough and fix ALL workflow files.
...
CHANGES REQUESTED: 2 HIGH priority issues remain. trivy-action still unpinned in docker-build-push.yml and timeout-minutes missing in 3 workflows (docker-build-push.yml, k8s-deploy.yml, rollback.yml).
