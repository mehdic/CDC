...
**TASK:** Fix: Patient Delivery Tracking - Mock Configuration Issues

**REQUIREMENTS:**
QA FAILED: 7/12 tests passed, 5 unit tests failed.

FIX REQUIRED:
1. DeliveryMap tests blocked by jest.mock JSX error
2. useWebSocket mock returning undefined

Fix mock configurations in test files for:
- DeliveryMap component tests
- useWebSocket hook tests

Files location: web/src/apps/patient/features/delivery-tracking/

After fixing mocks, run tests to verify all tests pass.
...
DeliveryMap tests blocked by jest.mock JSX error, useWebSocket mock returning undefined
