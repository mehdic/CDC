...
**TASK:** T8-023: Proof of Delivery Capture

**REQUIREMENTS:**
## Task: Proof of Delivery Capture
...
- Capture patient signature (touch signature pad using react-native-signature-canvas)
...
- mobile/delivery-app/src/screens/ProofOfDelivery/
- mobile/delivery-app/src/components/SignatureCapture.tsx
- mobile/delivery-app/src/services/proofOfDeliveryService.ts
...
export const ProofOfDeliveryCapture: React.FC = ({ onComplete }) => {
  ...
  // Handle submit with signature, photo, timestamp, GPS
};
```

## Acceptance Criteria
- [ ] Signature capture working (stores as base64)
- [ ] Photo capture working (uses camera)
- [ ] Timestamp recorded automatically
- [ ] GPS location captured
- [ ] Offline support with sync queue
- [ ] NEGATIVE: Cannot submit without signature
