...
**REQUIREMENTS:**
Implement Patient E-Commerce Cart and Checkout functionality.

Features required:
1. Shopping cart management (add/remove/update quantities)
2. Cart persistence (localStorage + API sync)
3. Checkout flow with address selection
4. Payment method selection UI
5. Order confirmation screen
6. Cart badge/counter in navigation

Integrate with existing Product Catalog (PAT-ECOM-CAT already implemented).

Write comprehensive tests for cart operations and checkout flow.
