...
**TASK:** Fix: T8-037 Multi-Channel Messaging TypeScript Error

**REQUIREMENTS:**
QA FEEDBACK - FAIL:

43/43 contract tests passed, but 1 integration test suite failed to compile.

TypeScript error: RouterService instantiation uses invalid config object at line 60.

Fix the integration test type mismatch and ensure all tests compile and pass.
...
TypeScript error in integration test - RouterService config object invalid at line 60
