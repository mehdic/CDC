...
**TASK:** Fix: Patient VIP Portal - Missing Test IDs

**REQUIREMENTS:**
QA FAILED: 42/45 tests passed, 3 E2E tests failed.

FIX REQUIRED:
Add missing data-testid attributes to:
1. Page title element
2. Success alert element  
3. Tier cards

Location: web/src/apps/patient/features/vip/

After adding test IDs, verify all tests pass.
...
Missing data-testid attributes in page title, success alert, and tier cards
