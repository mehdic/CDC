...
**TASK:** QA: Patient E-Commerce Order History

**REQUIREMENTS:**
Verify implementation of T8-040 Patient E-Commerce Order History.

Test order history functionality in web/src/apps/patient/:
- Order history page
- Order detail view
