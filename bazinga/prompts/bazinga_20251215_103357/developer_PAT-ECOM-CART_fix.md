...
**TASK:** Fix: Patient E-Commerce Cart - React Native Component Issue

**REQUIREMENTS:**
TECH LEAD CHANGES REQUESTED:

HIGH PRIORITY ISSUE: Web HTML elements (span, div) used instead of React Native components (Text, View) in AppNavigator.tsx - this will cause runtime errors.

FIX REQUIRED:
1. Open mobile/patient-app/src/navigation/AppNavigator.tsx
2. Replace any <span> elements with <Text> from react-native
3. Replace any <div> elements with <View> from react-native
4. Ensure proper imports from 'react-native'

After fixing, run tests to verify the fix doesn't break anything.
...
Web HTML elements (span, div) used instead of React Native components (Text, View) - will cause runtime errors
