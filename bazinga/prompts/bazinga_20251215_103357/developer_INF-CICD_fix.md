...
**TASK:** T8-057: CI/CD Pipeline - Fix Workflow Syntax

**REQUIREMENTS:**
Tech Lead found issues in CI/CD workflows.

Fix required:
1. CRITICAL: Fix invalid reusable workflow syntax in environment-promotion.yml
2. HIGH: Pin action versions (use @v4 not @main)
3. HIGH: Add timeout-minutes to all jobs

DO NOT rewrite - just fix the specific issues identified.
...
CHANGES REQUESTED: 1 critical, 2 high priority issues. Critical: Invalid reusable workflow syntax in environment-promotion.yml - workflow will fail at runtime. Fix workflow syntax, pin action versions, add timeout-minutes.
