...
**TASK:** QA Re-test: T8-048 Nurse E2E Tests

**REQUIREMENTS:**
RE-TEST after Developer fix.

Developer fixed waitForNavigation → waitForURL for React SPA compatibility.
Modified LoginPage.ts with proper URL-based navigation waits.

Validate all E2E tests now pass.
