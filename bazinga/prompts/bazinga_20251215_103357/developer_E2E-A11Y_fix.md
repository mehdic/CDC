...
**TASK:** T8-052: Accessibility E2E Tests - Fix Routes

**REQUIREMENTS:**
QA Expert found 67/684 test failures.

Fix required:
1. Fix routing 404s for dashboards (routes returning 404)
2. Fix MOCK_AUTH for nurse role (API mocking incomplete)

The test code is correct - the infrastructure/routing is the issue.
...
617/684 accessibility E2E tests passed, 67 failed. Infrastructure issues: routing 404s for dashboards, nurse API mocking incomplete. Fix routes and MOCK_AUTH for nurse role.
