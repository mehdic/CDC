...
**TASK:** Fix: T8-038 Patient E-Commerce Test Infrastructure

**REQUIREMENTS:**
TECH LEAD GUIDANCE:

Jest/Node.js v25 incompatibility - test-exclude/glob API mismatch.

SOLUTION (choose one):
1. Downgrade to Node.js 22 LTS (recommended)
2. Override test-exclude to v7 in package.json

Apply fix, reinstall dependencies, and ensure all tests pass.
...
Downgrade to Node.js 22 LTS or override test-exclude to v7
