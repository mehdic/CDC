...
**TASK:** T8-056: Kubernetes Manifests

**REQUIREMENTS:**
Create Kubernetes deployment manifests for the MetaPharm Connect platform:
...
Use Kustomize for environment overlays. Follow K8s best practices.
