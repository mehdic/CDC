...
**TASK:** T8-051: Performance and Load Tests

**REQUIREMENTS:**
Implement performance and load testing suite:
- Page load time benchmarks (<200ms P95)
...
Use k6 or Artillery for load testing. Integrate with Playwright for frontend perf.
