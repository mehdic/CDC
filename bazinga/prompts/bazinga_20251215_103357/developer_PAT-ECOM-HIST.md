...
**REQUIREMENTS:**
Implement Patient Order History functionality.

Features required:
1. Order history list view with pagination
2. Order detail view (items, quantities, prices, status)
3. Order status tracking (pending, processing, shipped, delivered)
4. Reorder functionality (add previous order items to cart)
5. Order filtering by date/status
6. Download invoice/receipt as PDF

Write comprehensive tests for order history display and reorder flow.
