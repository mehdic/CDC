...
**TASK:** Fix Backend Security Vulnerabilities

**REQUIREMENTS:**
## Objective

Fix all security vulnerabilities in the backend/ directory flagged by Dependabot and npm audit.
...
## Common Vulnerable Packages (Backend)
