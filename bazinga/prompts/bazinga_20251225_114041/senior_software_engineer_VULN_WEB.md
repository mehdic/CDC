...
**TASK:** Fix Web Frontend Security Vulnerabilities

**REQUIREMENTS:**
## Objective

Fix all security vulnerabilities in the web/ directory flagged by Dependabot and npm audit.
...
## Common Vulnerable Packages (Web)

- vite (build tool) - often has high severity
- esbuild (bundler)
- postcss (CSS processing)
- Various React dependencies
- axios/fetch libraries

## Acceptance Criteria

- [ ] npm audit shows 0 vulnerabilities in web/
- [ ] Build succeeds
- [ ] All tests pass
