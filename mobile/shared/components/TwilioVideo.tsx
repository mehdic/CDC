...
const TwilioVideoComponent = forwardRef<TwilioVideoHandle, TwilioVideoProps>(
  (
    {
      accessToken,
      roomName,
    ...
    useImperativeHandle(ref, () => ({
      setLocalVideoEnabled: (enabled: boolean) => {
        if (twilioRef.current) {
          twilioRef.current.setLocalVideoEnabled(enabled);
          setLocalVideoEnabled(enabled);
        }
      },
      setLocalAudioEnabled: (enabled: boolean) => {
        if (twilioRef.current) {
          twilioRef.current.setLocalAudioEnabled(enabled);
...
TwilioVideoComponent.displayName = 'TwilioVideoComponent';
