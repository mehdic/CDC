...
// Default includes common development ports: 3000 (web), 3001 (alt web), 5173 (Vite dev), 19006 (Expo mobile)
const allowedOriginsString = process.env['ALLOWED_ORIGINS'] || 'http://localhost:3000,http://localhost:3001,http://localhost:5173,http://localhost:19006';
