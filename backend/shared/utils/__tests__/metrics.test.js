...
describe('Prometheus Metrics', () => {
    ...
    describe('Cache metrics', () => {
        ...
        it('should update cache size', () => {
            (0, metrics_1.updateCacheSize)('user-cache', 1024 * 1024); // 1MB
            (0, metrics_1.updateCacheSize)('product-cache', 512 * 1024); // 512KB
    ...
    describe('Edge cases', () => {
        ...
        it('should handle very large durations', () => {
            (0, metrics_1.recordRequestDuration)('GET', '/api/slow', 3600000, 200); // 1 hour
            expect(metrics_1.recordRequestDuration).toBeDefined();
        });
