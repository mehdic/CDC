/**
 * Video Call Page - Patient App
 * Teleconsultation video call interface for patients
 * Task: T8-003 - Patient App Video Implementation
 */
...
const VideoCall: React.FC = () => {
  ...
  // Get pharmacist info
  const provider = consultation.pharmacist;
          ...
          <Box display="flex" alignItems="center" gap={2}>
            ...
            <Box>
              ...
              <Typography variant="body2" color="text.secondary">
                {providerName} • {format(parseISO(consultation.scheduled_start), 'MMM d, yyyy HH:mm')}
              </Typography>
            </Box>
          </Box>
        ...
        {!isCallStarted ? (
          ...
          >
            ...
            <Typography variant="body1" color="text.secondary" textAlign="center" maxWidth={500}>
              You are about to join a video call with {providerName}.
            ...
            <Alert severity="info" sx={{ maxWidth: 500 }}>
              <Typography variant="body2">
                ...
                <br />
                • You can mute/unmute or turn off your camera during the call
                <br />• Press "End Call" when finished
              </Typography>
            </Alert>
