...
const AddUserDialog: React.FC<{
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Ajouter un nouvel utilisateur / Add New User</DialogTitle>
          <DialogDescription>
            Créez un nouveau compte utilisateur avec permissions
          </DialogDescription>
        </DialogHeader>
    ...
    <div className="p-6 max-w-6xl mx-auto">
      ...
      <Tabs defaultValue="users" className="w-full">
        ...
        <TabsContent value="users" className="mt-6">
          <div className="space-y-4">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-xl font-semibold">Utilisateurs / Users</h2>
        ...
        <TabsContent value="audit" className="mt-6">
          <h2 className="text-xl font-semibold mb-4">Journal d'Audit / Audit Log</h2>
          <AuditLogTab />
        </TabsContent>
